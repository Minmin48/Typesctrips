    ...
    return (
        <div>
            <div className="wrapper-search-banner bg-white rounded-lg ">
                <div className="tabs-nav border-b-2 border-gray-200 mr-10">
                    <ul className="flex justify-center items-center ">
                        ...
                        <li className="pt-5 pb-3.5 px-6 ml-2 mt-2 relative">
                            <a href="" className="flex items-center text-base"><svg width={21} height={21} viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M20.85 14.5V12.5L12.429 7.5V2C12.429 1.17 11.724 0.5 10.85 0.5C9.97598 0.5 9.27098 1.17 9.27098 2V7.5L0.849976 12.5V14.5L9.27098 12V17.5L7.16598 19V20.5L10.85 19.5L14.534 20.5V19L12.43 17.5V12L20.85 14.5Z" fill="#474747" />
                            </svg><span className="text-base font-semibold pl-2">Máy bay</span></a>
                            ...
                            <div className="flex justify-between items-center rounded-lg border-2 border-gray-200 min-h-full">
                                <div className="input-item-search min-h-full flex justify-start items-center border-r-2 border-gray-200 pl-4">
                                    ...
                                    <div className="ml-2 py-[3px]">
                                        ...
                                        <input type="text" className="outline-none font-medium max-w-[100px]" defaultValue="Hà Nội" />
                                    </div>
                                </div>
                                <div className="input-item-search min-h-full flex justify-start items-center border-r-2 border-gray-200 pl-8">
                                    ...
                                    <div className="ml-2 py-[3px]">
                                        ...
                                        <input type="text" className="outline-none font-medium max-w-[100px]" defaultValue="Sơn La" />
                                    </div>
                                </div>
                                <div className="hidden md:block">
                                    <div className=" input-item-search min-h-full flex justify-start items-center border-r-2 border-gray-200 pl-4">
                                        ...
                                        <div className="ml-2 py-[3px]">
                                            ...
                                            <input type="text" className="outline-none font-medium max-w-[120px]" defaultValue="T2, 18/03/2024" />
                                        </div>
                                    </div>
                                </div>
                                <div className="input-item-search min-h-full text-center px-5 py-[10px] hidden md:block">
                                    <a href="" className="whitespace-nowrap font-semibold text-[#2474E5]">Thêm ngày về</a>
                                </div>
                            </div>
                            <button className="inline-block whitespace-nowrap rounded bg-[#FFD333] px-[25px] py-[17px] ml-4 text-sm font-medium text-black hover:bg-indigo-600 hover:text-white focus:outline-none focus:ring active:bg-indigo-500">
                                Tìm kiếm
                            </button>
                        </div>
                    </div>
