                ...
                <div className="py-12 bg-[#F2F2F2] ">
                    <div className="container max-w-screen-lg mx-auto space-y-10 ">
                        <div className="flex items-start justify-start ml-24">
                            ...
                            {/*  */}
                            <div className="news hidden md:block">
                        ...
                        <div className="flex items-start justify-start  ml-24">
                            ...
                            <div className="garage">
                                ...
                                <div className="garage-container flex items-center">
                                    ...
                                    {/*  */}
                                    <ul className="underline font-semibold text-[10px] space-y-5 mr-[25px] hidden md:block">
                                    ...
                                    {/*  */}
                                    <ul className="underline font-semibold text-[10px] space-y-5 hidden md:block">
                        ...
                        <div className="flex items-start justify-start  ml-24">
                            ...
                            <div className="abouts mr-[93px] hidden md:block">
                                <h2 className="font-semibold text-[22px] mb-[21px]">
                                    Về chúng tôi
                                </h2>
                                <ul className="underline font-semibold text-[14px] space-y-5">
                            ...
                            <div className="payments mr-28 hidden md:block">
                                <h2 className="font-semibold text-[22px] mb-[21px]">
                                    Đối tác thanh toán
                                </h2>
                            </div>
                            <div className="dow-app">
                                ...
                                <img src="./7.svg" alt="" className="size-[164px]" />
                            </div>
                        </div>
                    </div>
                </div>
